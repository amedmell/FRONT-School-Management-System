...
<div class="form">
  ...
  <input  type="submit" id='save' class="btn btn-success mb-2" @click="createProf" value="Creer Etudiant ">
  <input  type="submit" id='save' class="btn btn-primary mb-2" @click="updateProf" value="Modifier Etudiant ">
...
methods:{
 ...
 async created(){
  ...
  try{
      const response =await axios.get('admin/getallprof');
